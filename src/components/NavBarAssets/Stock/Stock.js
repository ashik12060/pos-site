...
const Stock = () => {
  ...
  //   switch (actionType) {
  //     case "view":
  //       alert(`Viewing entry with reference no: ${entry.referenceNo}`);
  //       break;
  //     case "edit":
    ...
    <div className="bg-gray-100 min-h-screen">
      <div className="container mx-auto px-4 py-8">
                ...
                <tr key={index} className="hover:bg-gray-100">
                  ...
                  <td className="px-4 py-2 text-right">
                    <select
                      ...
                      onChange={(e) => handleAction(e.target.value, entry)}
                    >
        ...
        <div className="mt-4 flex flex-col md:flex-row md:justify-between items-center">
          <button
            className="bg-gray-300 hover:bg-gray-400 text-gray-700 font-bold py-2 px-4 rounded mb-2 md:mb-0"
            onClick={() => handlePageChange(currentPage - 1)}
            disabled={currentPage === 1}
          >
            Previous
